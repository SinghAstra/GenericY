...
import EffortlessIntegration from "../components/effortless-integration";
...
export default function LandingPage() {
  ...
  return (
    <div className="w-full min-h-screen relative bg-background overflow-x-hidden flex flex-col ">
      <div className="w-full px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] relative flex flex-col mx-auto min-h-screen">
        <div className="w-[1px] h-full absolute left-4 sm:left-6 md:left-8 lg:left-0 top-0 bg-border shadow-[1px_0px_0px_theme(colors.background)] z-0"></div>
        <div className="w-[1px] h-full absolute right-4 sm:right-6 md:right-8 lg:right-0 top-0 bg-border shadow-[1px_0px_0px_theme(colors.background)] z-0"></div>

        <div className="pt-[9px] overflow-hidden flex flex-col justify-center items-center gap-4 sm:gap-6 md:gap-8 lg:gap-[66px] relative z-10">
          <div className="w-full h-12 sm:h-14 md:h-16 lg:h-[84px] absolute left-0 top-0 flex justify-center items-center z-20 px-6 sm:px-8 md:px-12 lg:px-0">
            <div className="w-full h-0 absolute left-0 top-6 sm:top-7 md:top-8 lg:top-[42px] border shadow-[0px_1px_0px_white]"></div>

            <div className="w-full bg-background max-w-[calc(100%-32px)] sm:max-w-[calc(100%-48px)] md:max-w-[calc(100%-64px)] lg:max-w-[700px] h-10 sm:h-11 md:h-12 py-1.5 sm:py-2 px-3 sm:px-4 md:px-4 pr-2 sm:pr-3 backdrop-blur-sm shadow-[0px_0px_0px_2px_white] overflow-hidden rounded-[50px] flex justify-between items-center relative z-30">
              <div className="flex justify-center items-center">
                <div className=" text-sm sm:text-base md:text-lg lg:text-xl font-medium leading-5 font-sans">
                  {siteConfig.name}
                </div>
                <div className="pl-3 sm:pl-4 md:pl-5 lg:pl-5 justify-start items-start hidden sm:flex flex-row gap-2 sm:gap-3 md:gap-4 lg:gap-4">
                  <div className="flex flex-col justify-center text-xs md:text-[13px] font-medium leading-[14px]">
                    Products
                  </div>
                  <div className="flex flex-col justify-center text-xs md:text-[13px] font-medium leading-[14px]">
                    Pricing
              ...
              <div className="h-6 sm:h-7 md:h-8 flex justify-start items-start gap-2 sm:gap-3">
                <div className="px-2 sm:px-3 md:px-[14px] py-1 sm:py-[6px] bg-secondary shadow-[0px_1px_2px_rgba(55,50,47,0.12)] overflow-hidden rounded-full flex justify-center items-center">
                  <div className="flex flex-col justify-center text-xs md:text-[13px] font-medium leading-5">
                    Log in
                  </div>
                </div>
              </div>
          ...
          <div className="pt-16 sm:pt-20 md:pt-24 lg:pt-[216px] pb-8 sm:pb-12 md:pb-16 flex flex-col justify-start items-center px-2 sm:px-4 md:px-8 lg:px-0 w-full sm:pl-0 sm:pr-0 pl-0 pr-0">
            <div className="w-full max-w-[937px] lg:w-[937px] flex flex-col justify-center items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6">
              <div className="flex flex-col justify-center items-center gap-4 sm:gap-5 md:gap-6 lg:gap-8">
                <div className="w-full font-bold max-w-[748px] lg:w-[748px] text-center flex justify-center flex-col text-[24px] xs:text-[28px] sm:text-[36px] md:text-[52px] lg:text-[80px] leading-[1.1] sm:leading-[1.15] md:leading-[1.2] lg:leading-24 px-2 sm:px-4 md:px-0">
                  Build Awesome
                  <br />
                  Landing Pages
                </div>
                <div className="w-full max-w-[506px] lg:w-[506px] text-center flex justify-center flex-col sm:text-lg md:text-xl leading-[1.4] sm:leading-[1.45] md:leading-[1.5] lg:leading-7  px-2 sm:px-4 md:px-0 lg:text-lg font-medium text-sm">
            ...
            <div className="w-full max-w-[497px] lg:w-[497px] flex flex-col justify-center items-center gap-6 sm:gap-8 md:gap-10 lg:gap-12 relative z-10 mt-6 sm:mt-8 md:mt-10 lg:mt-12">
              ...
              >
                <div className="h-10 sm:h-11 md:h-12 px-6 sm:px-8 md:px-10 lg:px-12 py-2 sm:py-[6px] relative bg-primary shadow-[0px_0px_0px_2.5px_rgba(255,255,255,0.08)_inset] overflow-hidden rounded-full flex justify-center items-center">
                  <div className="flex flex-col justify-center text-primary-foreground text-sm sm:text-base md:text-[15px] font-medium leading-5">
                    View Github
                  </div>
                </div>
              </Link>
